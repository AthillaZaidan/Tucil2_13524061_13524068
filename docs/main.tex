...
\fancypagestyle{plain}{%
	...
	\fancyhead[R]{%
		\begin{minipage}{9cm}
			...
			\normalsize Laporan Akhir Tugas Kecil 2\\
...
\begin{document}
	...
	\begin{titlepage}
		...
		% ---------- Judul utama ----------
		{\LARGE \textbf{Tugas Kecil 2}\par}
		\vspace{0.2cm}
		{\LARGE \textbf{Gemilang}\par}
		\vspace{0.8cm}
		{\large IF2211 | Strategi Algoritma\par}
		\vspace{0.2cm}
		{\large OctoVox : Konversi Model 3D Menjadi Voxel Menggunakan Octree Berbasis Divide and Conquer\par}
		\vspace{0.2cm}
...
\begin{titlepage}
	...
	{\large IF2211 Strategi Algoritma\par}
	\vspace{0.2cm}
	{\large \textit{Divide and Conquer} sebagai Strategi dalam Konversi Objek Tiga Dimensi menjadi Objek Kubus berbasis Struktur Data \textit{Octree}\par}
	\vspace{0.2cm}
	{\large Semester 2 Tahun 2025/2026\par}
...
\chapter{\textit{Problem Statement}}
\input{sections/01-pendahuluan}
